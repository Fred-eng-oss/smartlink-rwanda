    ...
    return (
        <div className="space-y-0 pb-20">
            ...
            <section className="relative bg-gradient-to-br from-[#071A35] via-[#0D2847] to-[#0F62FE] py-20 sm:py-28 overflow-hidden select-none">
                ...
                <div className="absolute top-1/3 left-10 w-72 h-72 bg-[#00A86B]/10 rounded-full blur-3xl" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((s: Service, index: number) => (
                            <div
                                key={s.slug}
                                className="bg-[#F8FAFC] dark:bg-[#071A35] rounded-2xl border border-[#E2E8F0] dark:border-slate-700/50 overflow-hidden card-hover flex flex-col justify-between p-8 group"
                            >
                                <div className="space-y-6">
                                    <div className="p-4 bg-[#0F62FE]/10 rounded-2xl w-fit transition-all duration-300 group-hover:bg-[#0F62FE] group-hover:text-white">
                                        <span className="text-[#0F62FE] group-hover:text-white transition-colors duration-300">
                                            {getServiceIcon(index)}
                                        </span>
                                    </div>
                                    <h3 className="text-xl font-bold text-[#0F172A] dark:text-[#F1F5F9] font-display group-hover:text-[#0F62FE] transition-colors">
                                        {s.name}
                                    </h3>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="inline-flex items-center gap-1.5 text-xs font-bold bg-[#0F62FE]/10 text-[#0F62FE] px-3 py-1.5 rounded-full">
                                            <Sparkles className="w-3 h-3" />
                                            {s.features.length} Features
                                        </span>
                                    </div>
                                </div>
                                <div className="pt-6 mt-6 border-t border-[#E2E8F0] dark:border-slate-700/50 flex justify-between items-center">
                                    <Link
                                    ...
                                    <Link
                                        ...
                                        className="text-xs font-bold bg-[#071A35] hover:bg-[#0F62FE] text-white px-5 py-2 rounded-full transition-all duration-300"
                                    >
                                        Get Started
                                    </Link>
                                </div>
                        ...
                        <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
                            ...
                            <div className="pt-4">
                                <Link
                                    ...
                                    className="inline-flex items-center gap-2 bg-white hover:bg-[#F8FAFC] text-[#071A35] font-bold text-sm uppercase tracking-wide px-8 py-3.5 rounded-full shadow-lg shadow-black/10 transition-all duration-300 hover:-translate-y-0.5"
                                >
