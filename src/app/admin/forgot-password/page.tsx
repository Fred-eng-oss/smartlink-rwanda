            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center space-y-5 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm mt-2 font-sans" style={{ color: "#6B7280" }}>
                            {step === "email"
                ...
                <div className="bg-white rounded-2xl p-8 shadow-2xl">
                    {step === "email" ? (
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3.5 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0F62FE] focus:border-transparent transition-all border-0"
                        ...
                        <form onSubmit={handleResetSubmit} className="space-y-5">
                            <div className="p-3 rounded-xl flex items-center gap-3" style={{ backgroundColor: "#F8FAFC", border: "1px solid #E5E7EB" }}>
                                <div className="p-1.5 rounded-lg" style={{ backgroundColor: "#00A86B20" }}>
                                    <CheckCircle className="w-4 h-4" style={{ color: "#00A86B" }} />
                                </div>
                                <span className="text-xs font-semibold" style={{ color: "#1F2937" }}>{email}</span>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-12 py-3.5 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0F62FE] focus:border-transparent transition-all border-0"
                                        style={{ backgroundColor: "#F8FAFC", color: "#1F2937" }}
                                    />
                                    <button
                                        type="button"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Key className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "#6B7280" }} />
                                    <input
                            ...
                            <button
                                ...
                                className="w-full text-center text-xs font-medium transition-colors flex items-center justify-center gap-1"
                                style={{ color: "#6B7280" }}
                            >
